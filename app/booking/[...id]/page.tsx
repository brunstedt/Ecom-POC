...
export default async function BookItem({params}: BookItemProps) {
    ...
    return (
        <div className="text-white flex flex-col gap-2 bg-black p-6 bg-opacity-60">
                ...
                <div className='md:pl-6 w-full md:w-1/2 flex flex-col gap-4 '>
                    ...
                    <div className="flex gap-8 items-center mt-4">
                        ...
                        <form action={addToCartActionWithId}>
                            <button className="py-3 px-4 bg-pink-500 font-bold rounded hover:bg-pink-600 tracking-wide" type="submit">Book now</button>
                        </form>
                    </div>
                </div>
            </div>
